...
export const achievementDefinitions: AchievementDefinition[] = [
  ...
  {
    id: 'chapter2-comeback',
    title: '证据窗口',
    description: '达成第二章“程序性翻盘”结局。',
    category: 'conflict',
    grade: 'yi',
    points: 60,
    reward: '解锁对抗余辉特效',
    check: (state) => state.visitedEndings.includes('endingchapter2_comeback'),
    progress: (state) => ({
      current: state.visitedEndings.includes('endingchapter2_comeback') ? 1 : 0,
      total: 1,
    }),
  },
  {
    id: 'chapter3-firewall',
    title: '风控之盾',
    description: '达成第三章“程序化反制”结局。',
    category: 'relationship',
    grade: 'yi',
    points: 60,
    reward: '解锁关系护幕特效',
    check: (state) =>
      state.visitedEndings.includes('endingchapter3_proceduralwin'),
    progress: (state) => ({
      current: state.visitedEndings.includes('endingchapter3_proceduralwin')
        ? 1
        : 0,
      total: 1,
    }),
  ...
  {
    id: 'chapter4-guardian',
    title: '守护闭环',
    description: '达成第四章“保护闭环”结局。',
    category: 'destiny',
    grade: 'jia',
    points: 120,
    reward: '解锁守护脉冲特效',
    check: (state) => state.visitedEndings.includes('endingchapter4_protectwin'),
    progress: (state) => ({
      current: state.visitedEndings.includes('endingchapter4_protectwin')
        ? 1
        : 0,
      total: 1,
    }),
  ...
  {
    id: 'chapter-arc-master',
    title: '三章贯通',
    description: '连续打通第二章、第三章与第四章的正向关键结局。',
    category: 'destiny',
    grade: 'jia',
    points: 160,
    reward: '解锁三段式辉光特效',
  ...
  },
  {
    id: 'branch-historian',
    title: '分支编年史',
    description: '在第二至第四章累计解锁 10 个不同结局。',
    category: 'archive',
    grade: 'yi',
    points: 80,
    reward: '解锁档案星轨特效',
